...
const AddDoctor = () => {
    ...
    const [speciality, setSpeciality] = useState('Posture Correction Exercises')
        ...
        <div className='bg-white px-8 py-8 border rounded w-full max-w-6xl max-h-[80vh] overflow-scroll'>
            ...
            <div className='flex flex-col lg:flex-row items-start gap-10 text-gray-600'>
                ...
                <div className='w-full lg:flex-1 flex flex-col gap-4'>
                    ...
                    <div className='flex-1 flex flex-col gap-1'>
                        <p >Address</p>
                        <input onChange={(e)=>setAddress1(e.target.value)} value={address1} className='border rounded px-3 py-2  mb-4' type="text" placeholder="Address 1" required />
                ...
                <div>
                    ...
                    <button type='submit' className='bg-primary px-10 py-3 mt-4 text-white rounded-full active:bg-blue-700'>Add Doctor</button>
